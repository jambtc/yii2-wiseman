...
<aside class="main-sidebar <?= $darkmode ?> elevation-4">
    ...
    <div class="sidebar">
        ...
        <?php
        $items[] = [
            'label' => Yii::t('app','Manage lots'), 'url' => ['lots/index'], 'icon' => 'book',
        ...
        //     // $subarray[] = ['label' => Yii::t('app','Notifications'), 'url' => ['notifications/index'], 'iconStyle' => 'far', 'icon' => 'comment'];
        //
        //
        //     // $items[] = [
        ...
        if (Yii::$app->user->id == 1){
            $items[] = [
                    ...
                    'items' => [
                        ...
                        ['label' => Yii::t('app','Subscriptions'), 'url' => ['/subscriptions/index'], 'icon' => 'mail-bulk'],
                        ['label' => Yii::t('app','App log'), 'url' => ['/logs/index'], 'icon' => 'clipboard-list'],
            ...
            $items[] = [
                    ...
                    'icon' => 'clipboard-list',
                    'items' => [
                        ['label' => Yii::t('app','Components'), 'url' => ['/components/index'], 'icon' => 'puzzle-piece'],
                        ['label' => Yii::t('app','Products'), 'url' => ['/products/index'], 'icon' => 'wine-bottle'],
                    ],
                ];
        }
        $subarray = null;
